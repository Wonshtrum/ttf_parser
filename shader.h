...
u32 compile_shader(const char* name, u32 type, const char* source) TOGGLE_H_IMPL({
...
u32 new_shader(const char* name, const char* vs_src, const char* fs_src) TOGGLE_H_IMPL({
